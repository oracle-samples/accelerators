 ...
 *  SHA1: $Id: 86db97fe209a8e4668c5d3aae12e0396767b5813 $
 * *********************************************************************************************
...
using Accelerator.Siebel.RepairOrderAddin.RightNowServiceReference;
...
namespace Accelerator.Siebel.RepairOrderAddin
{
    public class RepairOrderAddIn : Panel, IWorkspaceComponent2
    {
        ...
        public RepairOrderAddIn(bool inDesignMode, IRecordContext RecordContext)
        {
            ...
            _repairOrderControl = new RepairOrderInformationControl();
        }
    ...
    public class RepairOrderAddInFactory : IWorkspaceComponentFactory2
    {
        ...
        public IWorkspaceComponent2 CreateControl(bool inDesignMode, IRecordContext RecordContext)
        {
            ...
            _wsAddIn = new RepairOrderAddIn(inDesignMode, _rContext);
            _wsAddIn._log = _log;
