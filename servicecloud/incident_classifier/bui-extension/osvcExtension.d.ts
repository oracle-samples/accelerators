 ...
 *  date: Tue Jan 31 12:45:06 IST 2023
 
 *  revision: rnw-23-02-initial
 *  SHA1: $Id: 3e40916b40343f81d8ecd400ad556308a68cab48 $
 * *********************************************************************************************
...
declare module ORACLE_SERVICE_CLOUD {
    ...
    export interface IExtensionProvider extends IExtensionDisposable {
        ...
        getInsightsContext(): IInsightsContext;
    ...
    export interface IInsightsContext {
        registerHandleInsightRequestReadyAction(callbackFunction: (param: any) => any): void;
        registerHandleInsightResponseReadyAction(callbackFunction: (param: any) => any): void;
        handleInsightRequestReady(param: any): IExtensionPromise<void>;
        handleInsightResponseReady(param: any): IExtensionPromise<void>;
    }
